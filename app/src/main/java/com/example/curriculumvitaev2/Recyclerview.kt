...
lateinit var recyclerExperienceAdapter: ExperinceAdapter
/**
...
class Recyclerview : Fragment() {
    ...
    override fun onCreateView(
        ...
        val recyclverView = view?.findViewById<RecyclerView>(R.id.rec)
        recyclerExperienceAdapter = ExperinceAdapter(gen)
